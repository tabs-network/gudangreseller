...
<div class="hero-static d-flex align-items-center">
    <div class="w-100">
                        ...
                        <form class="js-validation-signin" action="be_pages_auth_all.php" method="POST">
                            <div class="py-3">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg form-control-alt" id="login-username" name="admin_mail" placeholder="e-mail">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg form-control-alt" id="login-password" name="admin_password" placeholder="Password">
                                </div>
                                <div class="form-group">
        ...
        <div class="font-size-sm text-center text-muted py-3">
            <strong>Gudang Reseller</strong> &copy; <span data-toggle="year-copy"></span>
        </div>
        <!-- END Footer -->
    </div>
</div>
...
<!-- Page JS Plugins -->
<script src="{{url('assets/dashboard/js/plugins/jquery-validation/jquery.validate.min.js')}}"></script>

<!-- Page JS Code -->
<script src="{{url('assets/dashboard/js/pages/op_auth_signin.min.js')}}"></script>
