...
@section('mtDesc', 'Written by A.N. Author, Illustrated by V. Gogh, Price: $17.99, Length: 784 pages, Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis doloremque id nobis quaerat voluptatibus, laudantium cupiditate velit tempora,ipsa
minima, .')
    ...
    <div class="bg-light-1 shadow-sm p-3">
        <div class="row">
            <div class="col-md-4 mb-3">
                <div class="shadow-sm">
                    <img src="{{url('engine/storage/app/product/500x500/'.$product->product_cover)}}" class="card-img-top" alt="...">
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active p-3" id="deskripsi" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="tab-pane fade p-3" id="stok" role="tabpanel" aria-labelledby="contact-tab">Stok</div>
                </div>
                <div class="text-end">
