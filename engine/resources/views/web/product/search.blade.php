...
@section('content')
<main>
    <section class="section-light container mt-3">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a
                            href="{{route('web.product.index')}}"><span>Produk</span></a></li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="section-light container mt-3">
        <div class="row">
            ...
            <div class="col-12 col-lg-9">
                <h1 class="fs-3">Produk Gudang Reseller</h1>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="d-flex col-6 col-md-6 col-lg-3">
                        <div class="bg-light shadow-sm">
                            <a href="{{route('web.product.show', $v->product_slug)}}" class="txt-decoration-none">
                                ...
                                <div class="p-3">
                                    ...
                                    <p class="fs-5">Rp {{ rupiah($v->product_price) }}</p>
                                </div>
                            </a>
                        </div>
                    </div>
