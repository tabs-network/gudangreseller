...
<div class="section-dark pt-5 pb-5 cl-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-7">
                <h1 class="h3 line fw-light mb-4 ">Gudang Reseller</h1>
                <p class="fw-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione id beatae est in, earum, reprehenderit dolorum dicta unde minima repellat ipsam non neque? Fugiat nesciunt, maxime expedita illo, provident dolorum.
                </p>
            </div>
        </div>
    </div>
...
<div class="section-light pt-5 pb-5">
    <div class="container">
        <div class="p-5 bg-light-1 rounded-3 shadow-sm">
            <span class="h3 fw-light line">KATEGORI PILIHAN</span>
            <div class="row mt-5">
                ...
                <div class="col-6 col-md-2">
                    <div class="bg-2 rounded-3 shadow-sm">
                        ...
                        <div class="text-center">
                            <h3 class="h6 fw-light pt-4 pb-4">Tas Selempang</h3>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-2">
